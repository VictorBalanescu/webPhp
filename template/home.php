...
<div class="titolo">
    <h1>Coccola il tuo cane </h1>
</div>
<div class="contenuto">
    <p class="desC">Porta il tuo cane a farlo correre lui si divertira tantissimo!!<br>
        Correre con il cane apporta diversi benefici: aiuta il cane a scaricare le energie.
        rafforza il legame di intesa e complicità tra cane e Pet parent. aiuta a mantenersi in forma,
        sia il pet sia il proprietario.</p>
    <img class="ImgC" src="../../../webPhp/views/static/foto/corgi.jpg" alt=""/>
</div>
</body>
<footer class="footer">
